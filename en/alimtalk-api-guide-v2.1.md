...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (Status of Sending SMS/LMS appears as L4 under List Messages in General Messages section; no ko counterpart at this position and level) -->
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (Status of Resending SMS/LMS appears as L4 under List Messages in Authentication Messages section; no ko counterpart at this position and level) -->
<a id="status-of-resending-smslms"></a>
