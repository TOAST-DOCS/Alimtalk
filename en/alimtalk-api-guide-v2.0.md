...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (Appears under 'List Messages' for General Messages but ko has no equivalent subheading there; corresponds to k34 which belongs under k27 (Messages), not k10) -->
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (Appears under 'List Messages' for Authentication Messages but ko has no equivalent subheading there; similar misplacement as t13) -->
<a id="status-of-resending-smslms"></a>
