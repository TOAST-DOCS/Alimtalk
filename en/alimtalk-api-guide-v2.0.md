...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (SMS/LMS status heading appears under List Messages (k10/t10) at L4, but k10's subheadings only include Request (k11) and Response (k12); no ko counterpart exists at this location) -->
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (SMS/LMS resending status heading appears under Authentication Messages List Messages (k21/t22) at L4, but k21's subheadings only include Request (k22) and Response (k23); no ko counterpart exists at this location) -->
<a id="response-7"></a>
...
### Status of Sending SMS/LMS for Alternative Delivery
