...
* [API] Brand Message Result Update Query API Added
    ...
    * The queryable period is within the last 90 days, and the range per query is up to 31 days.

* [API] Changed Maximum Length of Brand Message 080 Opt-out Authentication Number
    * The maximum allowed length of the 080 opt-out authentication number has been changed from 9 to 10 characters.
