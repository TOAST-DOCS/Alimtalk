...
* [Console] Displayed the template blocked status in the AlimTalk template query tab
    * The template blocked status is now displayed on the AlimTalk template query tab.
* [Console] Added the bulk sending feature for Brand Message
    * Added a bulk sending feature using CSV and XLSX files.
* [Console] Added the Brand Message delivery statistics screen
    * A statistics screen by date, time slot, and day of the week is now available.
