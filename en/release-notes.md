...
#### Feature Updates
* [API] Added Brand Message Delivery Result Updates Query API
...
* [API] Changed Maximum Length of 080 Opt-Out Verification Code for Brand Messages
    * The maximum allowed length of the 080 opt-out verification code has been changed from 9 to 10 characters.
