<!-- pre-align:aligned sig=c09fd88e6e8b -->

<a id="notification-kakaotalk-bizmessage-release-notes"></a>
## Notification > KakaoTalk Bizmessage > Release Notes { #notification-kakaotalk-bizmessage-release-notes }
...
* [API] Brand Message Result Update Query API Added
    ...
    * The queryable period is within the last 90 days, and the range for a single query is up to 31 days.

* [API] Brand Message 080 Rejection Authentication Number Maximum Length Changed
    * The maximum allowed length of the 080 rejection authentication number has been changed from 9 to 10 characters.
