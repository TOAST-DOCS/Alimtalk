...
친구톡 Upgrade는 광고주(고객사)의 마케팅 수신 동의 회원(이하 마수동)을 대상으로 카카오톡 채널 친구 여부와 관계없이 광고성 메시지를 발송할 수 있는 메시지 상품입니다.
...
* 템플릿 및 자유형 발송이 가능합니다.
* 친구톡 Upgrade 발송 실패 시 문자 메시지로 대체 발송 가능합니다.
...
## 발송 전 유의사항
브랜드 메시지 M/N 타겟팅은 아래 조건을 모두 만족할 경우 발송할 수 있습니다.
- 비즈니스 인증 채널
- 사업자 번호 등록
- 채널 고객센터 전화번호 등록
- 채널 친구수 5만 이상
