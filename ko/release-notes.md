...
* [API, 콘솔] 알림톡 템플릿 유효성 변경
    * 알림톡 템플릿의 최대 글자수 제한이 1000자에서 1300자로 확대되어 더 긴 메시지를 발송할 수 있습니다.
...
* [콘솔] 브랜드 메시지 엑셀 다운로드 기능 추가
    * 브랜드 메시지 발송 결과 조회 화면에서 엑셀 다운로드 기능이 추가되었습니다.
    * 발송 이력을 엑셀 파일로 다운로드하여 관리할 수 있습니다.
...
* [콘솔] 브랜드 메시지 080 수신거부관리 초기화 버그 수정
...
### 2019. 06. 27.
* [콘솔] 친구톡 대량 발송 시, <b>대체 발송 지정 기능, 분할 발송 기능</b> 추가
...
* [API] 친구톡 v1.2 API 추가
    ...
    - 발송 응답 필드에 각 수신자별 <b>요청 성공/실패</b> 필드가 추가되었습니다.
