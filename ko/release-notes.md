...
* [API] 브랜드 메시지 기본형 발송시 수신자 별로 템플릿 이미지 필드를 변경하는 기능 추가
    * 브랜드 메시지 기본형 발송시 수신자 별로 템플릿 이미지 필드를 변경할 수 있는 imageParameters 필드가 추가되었습니다.
        * 기본형 발송시 imageParameters 필드를 통해 각 이미지 필드의 imageUrl, imageLink 의 값을 대체할 수 있습니다.
