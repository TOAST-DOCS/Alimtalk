...
| 발송/조회     | false | -2023 | 친구톡 메시지 본문이 400글자를 초과할 경우(이미지 첨부)                                                                                                                    | The 'content' is too long. If you request the 'image', It can be less than 400 characters.                                                                                                                                                                                                                                                                                 |
| 발송/조회     | false | -2024 | 친구톡 메시지 본문이 1,300글자를 초과할 경우                                                                                                                          | The 'content' is too long. It can be less than 1,300 characters without any image.                                                                                                                                                                                                                                                                                         |
...
| 친구톡 호환 발송 | false | -3220 | 친구톡 헤더가 최대 길이를 초과함. 프리미엄 비디오 타입 헤더의 최대 길이는 20자임                                                                                                         | The 'header' is too long. If you request the 'video', It must be less than 20 characters.                                                                                                                                                                                                                                                                                  |
