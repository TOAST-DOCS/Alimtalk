...
| **画像**         | - 画像タイプの場合、「画像 + メッセージ + ボタン + クーポン」で構成されます。<br>- 画像とメッセージフィールドは必須で、メッセージは最大1,300文字まで登録可能です。ボタン及びクーポンフィールドは任意です。<br>- 画像の場合、通常画像アップロードAPIでアップロードした画像を使用する必要があります。<br>- `chat_bubble_type: "IMAGE"`がこれに該当します。                                                                                                                                                | 推奨サイズ: 800 X 400px (横500px以上)<br>アスペクト比: 2:1以上、3:4以下<br>ファイル形式及び容量制限: JPG、PNG / 最大5MB                                                                                                             |
...
| **プレミアム動画**    | - プレミアム動画タイプの場合、「ビデオ + ヘッダ + メッセージ + ボタン + クーポン」で構成されます。<br>- ビデオフィールドは必須で、ヘッダ、メッセージ、ボタン、クーポンフィールドは任意です。<br>- ビデオリンクはカカオTVにアップロードされた動画のみ使用可能です。(`https://tv.kakao.com/v/#{数字}` / `https://tv.kakao.com/channel/#{数字}/cliplink/#{数字}`)<br>- 通常画像としてアップロードした画像をサムネイルとして使用できます。<br>- 一般画像としてアップロードした画像をサムネイルとして使用できます。<br>- `chat_bubble_type: "PREMIUM_VIDEO"`がこれに該当します。                             | (任意) 推奨サイズ: 800 X 400px (横500px以上)<br>縦横比: 2:1以上、3:4以下<br>ファイル形式及び容量制限: JPG, PNG / 最大                                                                                                                                                                                                         |                                                                                                                                                                                                   |
