...
* 즉시 발송: 친구톡 Upgrade 수신자를 확인하지 않고 즉시 발송합니다. 발송 상태는 <b>대량 발송 조회</b> 탭에서 확인할 수 있습니다.

### 대체 발송
친구톡 Upgrade 발송을 실패한 경우 해당 내용을 문자 메시지로 대체 발송할 수 있는 기능입니다.
...
* 친구톡 Upgrade에서는 NHN Cloud의 SMS 서비스 연동을 통해 '080 수신거부 관리'와 '대체 발송' 기능을 하나의 smsAppkey로 통합 관리합니다.
...
### 대체 발송 관리
* 친구톡 Upgrade 발송을 실패할 경우 해당 내용을 문자 메시지로 대체 발송하도록 설정할 수 있습니다.
...
* <b>대체 발송 여부</b>를 <b>사용 안 함</b>으로 설정할 경우 친구톡 Upgrade 발송 시 해당 검색용 아이디의 채널은 대체 발송이 불가합니다.
